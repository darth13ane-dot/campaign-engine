...
| Next tactical release | To be scheduled | PF2e Tactical Control | Active scene viewer, tokens, targeting, movement, doors, PF2e encounters, initiative, and conditions | Destructive actions require confirmation; encounter state refreshes without replacing campaign canon |
