...
| 1.14.0 | Shipped September 20, 2026 | Prepared scenes at the table | Scene-specific references, focused situations, inline record reader, durable capture drafts, ended-session protection | Stable links survive prep, live play, packets and carry-forward; drafts survive actions and restarts; ended play stays read-only; published Windows package and feeds verified |
| 1.15.0 | Current planning release | Sources beside the session | PDF-page excerpts in notes drafting, exact scene links, searchable live pins, GM packets and continuity | Source and page identities survive workflows; requests remain scoped; offline/native persistence and published artifacts verified |
