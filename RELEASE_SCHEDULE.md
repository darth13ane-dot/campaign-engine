...
| 1.12.0 | Current implementation milestone | Recoverable browser storage | IndexedDB migration, transactional current/previous saves, exact legacy recovery copies, stale-tab protection, explicit reload and preserved older-app branches | 24.57 MB fixture survives offline browser restart; aborted and interrupted writes retain committed data; migration, conflicts, recovery, native regression and release verification pass |
