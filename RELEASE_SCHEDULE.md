...
| 1.13.0 | Current planning release | Notes into playable preparation | Selected source excerpts, session brief, manual and optional AI drafts, exact quotes, editable approval, retained attribution | Drafts survive reload and export; stale and invalid citations block approval; selected pieces append once; private sources, canon and live progress remain protected |
