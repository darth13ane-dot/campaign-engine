...
contextBridge.exposeInMainWorld("campaignEngineDesktop", {
  ...
  clearApiKey: () => ipcRenderer.invoke("desktop:api-key-clear"),
  loadFoundryApiKey: () => ipcRenderer.invoke("desktop:foundry-api-key-load"),
  saveFoundryApiKey: apiKey => ipcRenderer.invoke("desktop:foundry-api-key-save", apiKey),
  clearFoundryApiKey: () => ipcRenderer.invoke("desktop:foundry-api-key-clear"),
