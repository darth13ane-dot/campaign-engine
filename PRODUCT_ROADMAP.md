...
| Schema and import | Shared browser/desktop validation rejects ambiguous campaign identities and malformed supported containers. v1.15.1 gives preparation format 3 a shared version guard, preserves format 2 content in place, and checkpoints before upgrading saved workflows. Older published builds protect the new format. Extend migration and field validation coverage as models evolve. |
