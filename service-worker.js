const CACHE_NAME = "campaign-engine-shell-v37";
const APP_SHELL = [
  "./",
  "./index.html",
  "./workspace-persistence.js?v=2",
  "./campaign-history.js?v=1",
  "./campaign-search.js?v=3",
  "./source-library.js?v=1",
  "./workspace-views.js?v=3",
  "./bootstrap.js?v=1",
