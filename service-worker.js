const CACHE_NAME = "campaign-engine-shell-v43";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./session-prep.js?v=6",
  "./session-prep-views.js?v=7",
  "./session-prep.css?v=3",
  "./session-table.js?v=1",
  "./session-table-views.js?v=1",
  "./session-table.css?v=1",
  "./session-workflow.js?v=6",
  "./prep-continuity.js?v=3",
